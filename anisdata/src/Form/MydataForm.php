<?php
namespace Drupal\anisdata\Form;
...
class MydataForm extends FormBase {
    ...
    public function submitForm(array &$form, FormStateInterface $form_state) {
        ...
        if (isset($_GET['num'])) {
            ...
            $query->update('anisdata')
                ->fields($field)
                ->condition('id', $_GET['num'])
                ->execute();
            drupal_set_message("succesfully updated");
            $form_state->setRedirect('anisdata.display_table_controller_display');
        }
        else
        {
            $field  = array(
            ...
            $query = \Drupal::database();
            $query ->insert('anisdata')
                ->fields($field)
                ->execute();
            drupal_set_message("succesfully saved");
            $response = new RedirectResponse("/drupaltest/anisdata/hello/table");
            $response->send();
        }
    }
}